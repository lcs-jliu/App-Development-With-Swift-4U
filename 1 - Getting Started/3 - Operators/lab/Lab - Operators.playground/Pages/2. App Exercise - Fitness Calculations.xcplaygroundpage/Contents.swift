...
print(averageHRD)
print("The result is same from the last one becuase the total is divisble by 3, if not the double one should have decimal places")
/*:
